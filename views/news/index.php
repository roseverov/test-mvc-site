...
<link href="/template/style/style.css" rel="stylesheet" type="text/css" media="screen" />
</head>
<body>
	<div id="menu-wrapper">
		<div id="menu">
			...
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						...
						<p class="meta">Posted by <a href="#"> <?php echo $newsItem['authorname'];?> </a> on <?php echo $newsItem['date'];?>
